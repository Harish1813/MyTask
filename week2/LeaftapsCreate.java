...
public class LeaftapsCreate {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		driver.findElement(By.id("createContactForm_firstNameLocal")).sendKeys("Harish");
		...
		driver.findElement(By.xpath("(//input[@name='primaryEmail'])[4]")).sendKeys("Harish1813@gmail.com");
